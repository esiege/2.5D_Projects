...
app.service('key', function ($rootScope, gridActionDefinitions, engagedActionDefinitions, three_draw) {
	...
	function setKey(e) {
		...
		if (gridActionDefinitions.keyPress)
			gridActionDefinitions.keyPress(e.keyCode);
		if (engagedActionDefinitions.keyPress)
