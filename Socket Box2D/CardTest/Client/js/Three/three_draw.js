...
app.service('three_draw', function ($timeout, key, canvasService) {
    ...
    var addImagePlane = function (b) {
        ...
        b.texture = THREE.ImageUtils.loadTexture(imagePath, null, function (texture) {

            b.texture.magFilter = THREE.NearestFilter;
            b.texture.minFilter = THREE.LinearMipMapLinearFilter;
            b.material = new THREE.MeshPhongMaterial({ map: b.texture, transparent: true, alphaTest: 0.5 });

            if (b.body.details.flipX || b.body.details.flipY)
                b.material.side = THREE.DoubleSide;

            b.shape = new THREE.PlaneGeometry((texture.image.width / 2) * b.body.details.scale, (texture.image.height / 2) * b.body.details.scale);
            ...
            if (b.body.details.flipX)
                b.mesh.rotation.y = Math.PI;
            if (b.body.details.flipY)
    ...
    var addColorPlane = function (b) {
        b.material = new THREE.MeshPhongMaterial({ color: b.body.details.color });
    ...
    return {
        ...
        init: function () {
            canvasService.ready(function (c) {
                ...
                var light = new THREE.PointLight("white", .9, 0);
