		...
		if (this.debugDraw) {
			...
			while (obj) {
				...
				if (body) {
					...
					if (body.details.stepFunction)
					    body.details.stepFunction(body);
				}
				obj = obj.GetNext();
			}
...
var initBox = function (details, callback) {
	var d;
	...
	if (!document.getElementById(details.canvId)) {

		setTimeout(initBox, 1000, details, callback);

		console.log('awaiting canvas: ' + details.canvId);
		return -1;
	}
